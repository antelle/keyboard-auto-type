...
constexpr std::array<CGKeyCode, static_cast<size_t>(KeyCode::KeyCodeCount)> key_map{
    ...
    // numbers
    kVK_ANSI_0, kVK_ANSI_1, kVK_ANSI_2, kVK_ANSI_3, kVK_ANSI_4, kVK_ANSI_5, kVK_ANSI_6, kVK_ANSI_7, kVK_ANSI_8,
    kVK_ANSI_9,
    ...
    // function
    kVK_F1, kVK_F2, kVK_F3, kVK_F4, kVK_F5, kVK_F6, kVK_F7, kVK_F8, kVK_F9, kVK_F10, kVK_F11, kVK_F12, kVK_F13, kVK_F14,
    ...
    // keypad other
    kVK_ANSI_KeypadClear, kVK_ANSI_KeypadDecimal, kVK_ANSI_KeypadDivide, kVK_ANSI_KeypadEnter, kVK_ANSI_KeypadEquals,
    kVK_ANSI_KeypadMinus, kVK_ANSI_KeypadMultiply, kVK_ANSI_KeypadPlus,

    // others
    kVK_ANSI_Backslash, kVK_ANSI_Comma, kVK_ANSI_Equal, kVK_ANSI_Grave, kVK_ANSI_LeftBracket, kVK_ANSI_Minus,
    kVK_ANSI_Period, kVK_ANSI_Quote, kVK_ANSI_RightBracket, kVK_ANSI_Semicolon, kVK_ANSI_Slash,

    // modifiers
    kVK_Command, kVK_Control, kVK_Function, kVK_Option, kVK_Shift, kVK_RightCommand, kVK_RightControl, kVK_RightOption,
    kVK_RightShift, kVK_CapsLock,
    0, // NumLock
    0, // ScrollLock
